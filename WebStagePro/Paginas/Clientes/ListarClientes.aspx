<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="ListarClientes.aspx.cs" Inherits="WebStagePro.Paginas.Clientes.ListarClientes" %>
    ...
    <div class="container-fluid" style="height:auto; background-color:white; min-height:100vh; min-width:600px">
        ...
        <asp:GridView ID="GVProveedores" runat="server" AutoGenerateColumns="False" CssClass="table table-hover table-dark" DataKeyNames="dni" OnRowCommand="GVProveedores_RowCommand">
            <Columns>
                ...
                <asp:BoundField HeaderText="Fecha de nacimiento" DataField="Fecha de Nacimiento"/>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <asp:Label ID="Label4" runat="server" Text="Ocupacion"></asp:Label>
