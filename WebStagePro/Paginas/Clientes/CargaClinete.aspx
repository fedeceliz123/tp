<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="CargaClinete.aspx.cs" Inherits="WebStagePro.Paginas.Clientes.CargaClinete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="container-fluid" style="height:auto; background-color:white; min-height:100vh; min-width:600px">
         ...
         <div class="row" style="padding-top:30px">
            <h3 style="margin-left:10px">Carga de cliente</h3>
